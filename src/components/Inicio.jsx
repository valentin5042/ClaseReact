...
const Inicio = ({ abrirModal }) => {
  return (
    ...
    >
        <div className='flex flex-col lg:flex-row py-6 md:py-0 justify-around  items-center lg:px-20 px-10'>
            <div className="lg:w-4/12 w-full">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-around w-full mt-10">
                    ...
                    <button
                      onClick={ abrirModal }
                      className="text-white text-xl py-3 w-full lg:w-5/12 border mt-8 lg:mt-0 bg-transparent rounded-lg border-white hover:bg-white hover:text-red-600 transition"
                    >Contáctame</button>
                </div>
            </div>
...
Inicio.propTypes = {
  abrirModal: PropTypes.func.isRequered,
}
